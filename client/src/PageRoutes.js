...
function ProtectedStaffRoute({ children }) {
    const { currentUser } = useContext(UserContext);
    return currentUser.userType === "Admin" || currentUser.userType === "Doctor" ? children : <Navigate to="/login" />;
}
...
<Route path='microphone' element={
                    currentUser.userType === "Admin" ? <Microphone /> :
                        currentUser.userType === "Doctor" ? <Microphone /> :
                            currentUser.userType === "Patient" ? <Microphone /> :
                                <Navigate to="/login" />
                } />
