...
const LastName = credentialResponseDecoded.family_name;
const FirstName = credentialResponseDecoded.given_name;

const userId = credentialResponseDecoded.sub;
const encryptedId = encryptUserId(userId, lool);
setPassword(encryptedId);

setConfirmPassword(encryptedId);
      ...
      <div>
        ...
        <form id={styles.signUpform} name='signUpform' onSubmit={handleSubmit}>
          ...
          <div className='text-center'>
            ...
            <GoogleLogin id={styles.signUpBtn}
