...
export default function Sidebar({ open, handleDrawerClose, handleDrawerOpen }) {
    ...
    return (
        <Drawer className={styles.sidebar} variant="permanent" open={open} onMouseEnter={handleDrawerOpen} onMouseLeave={handleMouseLeavesDrawer} PaperProps={{ sx: { backgroundColor: '#71cfbe', color: 'white' } }}>
            <DrawerHeader>
                <IconButton onClick={handleDrawerClose}>
                    {/* {theme.direction === 'rtl' ? <ChevronRightIcon /> : <ChevronLeftIcon />} */}
                    <MenuIcon style={{ color: '#facf34f6' }} />
                </IconButton>
            </DrawerHeader>
            <Divider />
            <List>
            ...
            <ListItem key={"Microphone"} disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                >
                   <SmartToy sx={{ color: "white", fontSize: '25px' }} />
                </ListItemIcon>
                <ListItemText primary={"Medical Chat"} sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
            </List>  
            <List>
            <ListItem key={"Meeting"} disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                >
                   <Duo sx={{ color: "white", fontSize: '25px' }} />
                </ListItemIcon>
                <ListItemText primary={"Online Appointments    "} sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
            </List>
