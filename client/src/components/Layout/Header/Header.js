...
const Header = ({ open, handleDrawerOpen, headerTitle }) => {
  ...
  return (
    <AppBar position="fixed" open={open} style={{ backgroundColor: '#fff', color: "#facf34f6", boxShadow: "None" }} >
      <Toolbar>
        <IconButton
          color="inherit"
        ...
        <Typography variant="h4" noWrap component="div" onClick={redirectToHome} style={{color: "#facf34f6"}} sx={{ flexGrow: 1, fontWeight: 'bolder' }} >
          {/* {headerTitle} */}
