...
function AdminAppointment() {
    ...
    }, [date, departmentSelected, doctorSelected, appointmentType])
...
<div className='col-12'>
    <label for="appointmentType" className="col-sm-3 col-form-label ">Type: </label>
    <select name="appointmentType" id="appointmentType" class="col-form-select col-sm-7" aria-label="Default select example" required
