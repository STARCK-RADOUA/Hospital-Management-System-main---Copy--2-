            ...
            <div className="page-wrapper">
                <div className="content" style={{ marginTop: "2px" }}>
                    <div >
                            ...
                            <h3 className={styles.pageTitle}>Medicine</h3>
                    ...
                    <form action="/medicines" name="userFilter" >
                        <div className={styles.table}>
                            ...
                            <div className="col-sm-4 col-md-4">
                            <Link to="/dash/medicines/add" className="btn btn-primary float-right btn-rounded">
                                <i className="fa fa-plus"></i> Addd Medicine
                            </Link>
                        </div>
                        </div>
                    </form>
