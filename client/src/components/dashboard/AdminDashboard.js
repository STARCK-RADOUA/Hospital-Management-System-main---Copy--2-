...
import { style, useTheme } from "@mui/material/styles";
    ...
    >
      <div id={styles.welcomeBanner}>
        <div className="text-white">
          ...
          At Al Rahma Health Center, we are dedicated to providing every patient
          with the highest quality care possible
          <br />
          Our commitment to excellence in healthcare is complemented by our
          ...
          <div className={["", styles.statCard].join(" ")}>
            <div className={styles.dashWidget}>
              ...
              <div className={[" ", styles.dashWidgetInfo].join(" ")}>
                ...
                <a className={styles.widgetTitle1}>
          ...
          <div className={["", styles.statCard].join(" ")}>
            <div className={styles.dashWidget}>
              ...
              <div className={[" ", styles.dashWidgetInfo].join(" ")}>
                ...
                <a className={styles.widgetTitle2}>
          ...
          <div className={["", styles.statCard].join(" ")}>
            <div className={styles.dashWidget}>
              ...
              <div className={[" ", styles.dashWidgetInfo].join(" ")}>
                ...
                <a   className={styles.widgetTitle3}>
                  Appointments Today{" "}
        ...
        <div className={["", styles.statCard].join(" ")}>
          <div className={styles.dashWidget}>
            ...
            <div className={[" ", styles.dashWidgetInfo].join(" ")}>
              ...
              <NavLink className={styles.widgetTitle4}>
