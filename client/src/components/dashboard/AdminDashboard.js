        ...
        <Box className={styles.dashboardBody} component="main" sx={{ flexGrow: 1, p: 3 }}>
            <div id={styles.welcomeBanner}>
                <div className='text-white'>
                    ...
                    At Al Rahma Health Center, we are dedicated to providing every patient with the highest quality care possible
                    <br />
                    Our commitment to excellence in healthcare is complemented by our compassion for those we serve.
                </div>
            </div>
