...
function generateHeader(doc) {
    doc
        ...
        .fillColor("#444444")
        .fontSize(20)
        .text("AL Rahma Hospital", 110, 57)
        .fontSize(10)
        .text("AL Rahma Hospital", 200, 50, { align: "right" })
        .text("casablanca-ma 14/24", 200, 65, { align: "right" })
        .text("rue hopitale, 12, N7T 9U7", 200, 80, { align: "right" })
        .moveDown();
}
